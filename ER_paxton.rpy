...
label paxtonroute:
    ...
    show alex neutral frown 
    an "Hmm, Paxton is nowhere near the tables. He's probably behind the counter."
    an "I walk deeper into the cafe. Just like I guessed, {nw}"
    show alex up smile 
    ...
    menu:
        ...
        "Why do you have enough things to take care of an injury in your flat?":
            ...
            show paxton frown 
    scene bg paxton_room at Transform: 
        xpos -1440 ypos -400 zoom 0.75 
        linear 2.0 xpos -1600 
    with fade
    ...
    scene bg paxton_night at Transform:
        xpos -3520 ypos -937 zoom 1.25 
    with dissolve 
    ...
    menu:
        ...
        "I don't really feel like kissing him on the lips, so instead I lean up to kiss his cheek.":
            ## Paxton, blushing/shy
    ...
    a "Have fun at work."
    show alex smile blush 
    show paxton blush behind alex at closeleft: 
    ...
    menu:
        "I glance back to Paxton, then follow Finn and Zaina upstairs carefully.":
            ...
            show alex frown 
            show zaina frowntalk 
            z "I'm down for a little bit of excitement. {nw}" 
            show zaina unsure 
    ...
    scene bg paxton_room_1 with fade 
    ...
    show paxton down frowntalk at closeleft: 
        yalign -0.3 
        linear 1.5 yalign 0.5 
    p "Grab your coat. We should hurry."
    show paxton frown 
    ...
    an "We decide to spend the night at the hospital with Finn. At one point, when Zaina and I leave Finn's side to get some terrible hospital coffee that makes me think Paxton's lattes are a dream, I see Paxton sitting by Finn's bed with a serious expression."
