...
label commonroute:
    ...
    a unsure talk "My parents thought they were getting a boy... and they got me instead."
    show alex smile

    a down talk "But they didn't like any of the feminine variations, so... it's just Alex."
    show alex smile
    ...
    show alex up
    an blush "I can feel my cheeks get hot—usually, people just think it's weird." with Dissolve(1.0)
    ...
    show alex up
    an -blush "The way Zaina just moves on with the conversation snaps me out of my embarrassment." with Dissolve(1.0)
    ...
    z unsure frowntalk "Can't play dumb like you didn't {i}know{/i} you were trespassing when you also {i}broke in{/i}, after all."
    show zaina frown

    a down frowntalk "O-Oh."
    show alex frown

    a unsure frowntalk "That makes sense..."
    show alex frown

    z down frowntalk "I think Finn knows how to pick locks, but like, seriously, don't do it."
    show zaina frown

    z unsure frowntalk "Though..." 
    show zaina frown
    ...
    z down frowntalk "You're an ass sometimes, you know that?"
    show zaina frown
    ...
    show paxton unsure smile apron:
        xalign 0.85
        yalign 1.0
    with dissolve
    ...
    f down talk "I wasn't {i}that{/i} late."
    show finn smile

    f unsure talk "Anyway—me being late isn't what the topic is."
    show finn smile

    z unsure frowntalk "Maybe it should be."
    show zaina frown
    ...
    show alex -sweat
    an blush "I feel my face flush from the compliment, my heart pounding in my chest." with Dissolve(1.0)

    f unsure talk "Meet us back here, say... this Thursday, around 10:30 PM? We'll leave after Paxton's off work."
    show finn smile

    show alex up talk
    a -blush "I can do that!"  with Dissolve(1.0)
    show alex smile
    ...
    a blush "N-Newbie?" with Dissolve(1.0)
    ...
    show alex unsure talk
    a -blush "It was good meeting you too—all of you." with Dissolve(1.0)

    a up talk "I'll see you Thursday!"
    ...
    an "It feels nice to really {i}be{/i} with people again, outside of class, outside of schoolwork."

    an "This is just something fun."

    an "Or hopefully, it will be."

    p talk "Do we want to split off into pairs?"
    show paxton smile

    f talk "That sounds good to me."
    show finn smile

    f talk "Personally, whoever comes with me is getting dragged into looking for any secret pathways."
    show finn smile

    f talk "What about you two?"
    show finn smile

    z talk "Dunno yet, we'll see where inspiration and my camera take me. "
    show zaina smile
    ...
    an "This would be a good chance to get to know them all a little better..."

    f talk "Anywhere you wanna go in particular, Alex?"
    show finn smile
    ...
    p talk "Well, uh, I like writing a lot."
    show paxton smile
    ...
    a talk "So would you come up with a story about the people who might dance here?"
    show alex smile

    p talk "Hmm, yeah."
    show paxton smile

    p talk "I think maybe not a lot of dancing happened here. Maybe more of a focus on socializing..."
    show paxton smile

    p talk "Maybe a wealthy, middle aged couple lived here, retired early."
    show paxton smile

    p talk "And were just living out their days throwing parties for no good reason."
    show paxton smile
    ...
    ## https://freesound.org/people/mistermender/sounds/512340/ 
    ## if you prefer something else you can swap it it just needs to be upbeat

    p talk "Would you like to dance?"
    show paxton smile
    ...
    an "Breathless, I look up at Paxton. I can feel my cheeks burn."
    ...
    ## Scene 11D
    ##This isn’t a romance scene this is just how I’m labeling the end scene for this set of things so I don’t screw up the scene numbering again
    scene black
    with fadee
    ...
    an "It's hard to focus though, wondering about where we're gonna go tonight."

    ##scene change however you want to do this
    ##hospital bg
    scene bg hospital
    with fadee
