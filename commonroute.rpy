...
label commonroute:
    ...
    ##Zaina smile?
    z talk "Oh! Hey. Alex, right? Is it short for something?"
    show zaina smile
    ...
    z talk "So you went out to that old hospital by yourself?"
    show zaina smile
    ...
    p talk "So where do we wanna start?"
    show paxton smile

    f talk "Hmmm... The basic rules would be good I guess."
    show finn smile
    ...
    a talk "I would need a mask for that, right?"
    show alex smile
    ...
    a talk "And seeing the psych ward was also pretty cool--really cool, honestly."
    show alex smile

    a talk "It felt so timeless? Like aside from the dust everywhere, you could imagine people coming in again..."
    show alex smile
