...
label finnroute:
    ...
    an "Jeez, it's quiet even in the apartments now because of midterms. I hope Finn isn't {i}too{/i} stressed."
    ...
    menu:
        ...
        "What kind of cookies are they?":
            ...
            f happy "Heh, something like that."
            ##end choice
    ...
    f down frowntalk "{size=15}Don't taunt!{/size}"
    show finn frown
    ...
    menu :
        ...
        "What were you guys talking about?":
            z up frowntalk "Paxton was showing us latte art on some girl's cafe page."
            show zaina smile
    ...
    show alex up blush with Dissolve(0.5)
    a talk "Oh. Okay..."
    ...
    show alex unsure smile -blush with Dissolve(0.5)
    ...
    ##Finn smiling
    f up happy "I didn't think I was going to pass at all!"
    show finn smile
    ...
    ##Screen shake
    an "The main doors to the mansion bang before slowly opening up. Once again, the devil somehow knows my thoughts." with hpunch

    ##Finn sprite appears
    show finn up frown behind alex:
        xalign -0.05
        yalign 1.0
    with easeinleft
    ...
    f unsure talk "Tomorrow after class... Can you go on a walk with me? Please?"
    show finn frown
    ...
    f unsure frowntalk "Eh, this is awkward, but..."

    f up frowntalk "You know I care about you, right?"
    show finn frown
    ...
    f unsure side frowntalk "Before I came here, I wasn't in a good place mentally."

    f down frowntalk -side "I was lost, depressed, and... suicidal.{w=0.5} My boyfriend of many years and I broke up right before I moved here on top of it."
    show finn frown

    a unsure frowntalk "I'm so sorry, Finn..."
    show alex frown
    ...
    an neutral "But he doesn't linger. Finn looks directly at me—maybe even through me—and I know that he sees everything as it is now in the present."
    ...
    a "Right, they charge you for keeping animals here. Of course I will."
    ...
    ##Surprised Finn
    show finn up sweat frown with Dissolve(1.0)
    ...
    f down frowntalk blush "I-I mean just... to talk."
    show finn smile
    ...
    show alex up shock
    a -blush "You're burning up, Finn!" with Dissolve(0.5)
    ...
    z unsure frowntalk "Alex... Ugh, fine, if you insist. If you two lovebirds die I'm going to kill you."
    show zaina frown
    ...
    show finn down talk
    f -blush "Good point. Let's start with the basement."
    show finn frown
    ...
    menu:
        ...
        "That's not what I meant.":
            ...
            show finn smile
            show alex unsure talk
            a blush "Y-you're being ridiculous."
            show alex smile
            ...
            show finn smile
            show alex unsure talk
            a -blush "What are you-?!"
            show alex smile
            ##end choice

    #Screen shake
    an "Finn flashes me a grin, my only warning before he lifts me easily off the ground." with hpunch
    ...
    show alex smile at closeright:
        xalign 0.7
        yalign -0.35
    with easeinleft

    an smile -sweat "I sit on the bed and sure enough, his makeup supplies are ready and waiting for me. I've never seen him put on his makeup before, I wonder what he looks like without it..."
    ...
    an smile "I do as he says, stealing peeks at him pulling out black brushes—of course, they're black—and dabbing them across different shades of foundation."
    ...
    f down talk close "I'm exhausted..."
    show finn frown

    a down talk "Me, too. Thanks for lending me your clothes."
    show alex smile

    f up talk -close "Anytime."
    show finn smile
    ...
    an smile close "I join him on the bed and see how much of an easy target he is. Payback time... I kiss his cheek. Startled, he opens his eyes again and stares up at me."

    a up talk -close "Answer the question."
    show alex smile
